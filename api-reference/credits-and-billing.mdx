...
The backend also exposes `POST /api/v1/billing/webhook` for Stripe. That endpoint is internal to BrezelScraper's billing flow and is not part of the customer integration surface.
